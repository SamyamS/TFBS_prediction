...
from keras.layers import Embedding, LSTM, Dense, Conv1D, MaxPool1D, LSTM, Dense, Dropout, BatchNormalization
...
model.add(Conv1D(64, 5, strides=1, activation='tanh', padding='causal'))
